...
public class CustomSpaceConfig2 extends EmbeddedSpaceBeansConfig {
				...
				while (true) {
					...
					if(lineJustFetched==null)
						...
						if(wordsArray[0].equalsIgnoreCase("T")){
							...
							//tables.put(wordsArray[1],new TieredStorageTableConfig().setName(wordsArray[1]).setTimeColumn(wordsArray[2]).setPeriod(Duration.ofDays(24)));
							tables.put(Purchase.class.getName(), new TieredStorageTableConfig().setName(Purchase.class.getName()).setTimeColumn("orderTime").setPeriod(Duration.ofDays(25)));
						}
