...
(function (h) {
    ...
    function Ea(a, b) {
		var c = n.defaults.column,
            ...
            c = h.extend({}, n.models.oColumn, c, { nTh: b ? b : H.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [d], mData: c.mData ? c.mData : d, idx: d, bSearchable : d===1?true:false, bSortable : (d===4 || d===3)?false:true, });
        a.aoColumns.push(c);
