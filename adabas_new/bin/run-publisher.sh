...
if [ -z "$CLASSPATH" ]; then
  CLASSPATH="adabase-1.0.0-SNAPSHOT.jar"
fi
...
-Djavax.net.ssl.keyStore=keystore.jks -Djavax.net.ssl.keyStorePassword=xxx -Djavax.net.ssl.trustStore=keystore.jks \
-Djavax.net.ssl.trustStorePassword=xxx -Djavax.net.debug=ssl,keymanager"
fi
