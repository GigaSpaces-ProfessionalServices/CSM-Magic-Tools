mdmUrl=$dihost:6081
managerUrl="host-di1:6080"
flinkUrl="http://host-di1:8081"
diSsubscriptionManager="http://host-iidr1:6082"
diProcessorJar="/home/gsods/di-processor/latest-di-processor/lib/job-2.3.9.jar"
bootstrapServers="host-di1:9092,host-di2:9092,host-di3:9092"
kafkaGroupId="diprocessor"
spaceLookupGroups="xap-16.4.0"
spaceLookupLocators="host-manager1"
